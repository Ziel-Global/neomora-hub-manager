...
import { LayoutDashboard, CalendarDays, Users, ListOrdered, MessageSquare, BarChart3 } from "lucide-react";
...
const navItems = [
  ...
  { label: "Report", to: "/location-manager/reports", icon: BarChart3 },
